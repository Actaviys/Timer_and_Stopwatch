...
# Form implementation generated from reading ui file 'Files/window_ts.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("Files/Draft/icon-chess-clock-1949946.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"gridline-color: rgb(0, 0, 0);")
        ...
        self.CheckBox_Sound = QtWidgets.QCheckBox(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.CheckBox_Sound.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
        self.CheckBox_Sound.setContextMenuPolicy(QtCore.Qt.DefaultContextMenu)
        self.CheckBox_Sound.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.CheckBox_Sound.setAutoFillBackground(False)
        self.CheckBox_Sound.setStyleSheet("background-color: rgba(24, 161, 0, 0);")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("Files/icon_mute.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.CheckBox_Sound.setIcon(icon1)
        self.CheckBox_Sound.setIconSize(QtCore.QSize(16, 16))
        ...
        self.LineEdit_Time_Stopwath = QtWidgets.QLineEdit(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.LineEdit_Time_Stopwath.setFont(font)
        self.LineEdit_Time_Stopwath.setAlignment(QtCore.Qt.AlignCenter)
        self.LineEdit_Time_Stopwath.setObjectName("LineEdit_Time_Stopwath")
        self.horizontalLayout_5.addWidget(self.LineEdit_Time_Stopwath)
        self.ComboBox_Stopwatch = QtWidgets.QComboBox(self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Sitka Small")
        font.setPointSize(11)
        self.ComboBox_Stopwatch.setFont(font)
        self.ComboBox_Stopwatch.setStyleSheet("background-color: rgba(24, 161, 0, 200);")
        self.ComboBox_Stopwatch.setObjectName("ComboBox_Stopwatch")
        self.ComboBox_Stopwatch.addItem("")
        self.ComboBox_Stopwatch.addItem("")
        self.ComboBox_Stopwatch.addItem("")
        self.ComboBox_Stopwatch.addItem("")
        self.horizontalLayout_5.addWidget(self.ComboBox_Stopwatch)
        self.CheckBox_Stopwatch = QtWidgets.QCheckBox(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.CheckBox_Stopwatch.setFont(font)
        self.CheckBox_Stopwatch.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.CheckBox_Stopwatch.setStyleSheet("background-color: rgba(24, 161, 0, 0);")
        self.CheckBox_Stopwatch.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("Files/icon_block.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.CheckBox_Stopwatch.setIcon(icon2)
        self.CheckBox_Stopwatch.setIconSize(QtCore.QSize(25, 25))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.CheckBox_Sound.setText(_translate("MainWindow", "Off"))
        self.Output_Label_Stopwatch.setText(_translate("MainWindow", "00:00:00"))
        self.LineEdit_Time_Stopwath.setText(_translate("MainWindow", "234"))
        self.ComboBox_Stopwatch.setItemText(0, _translate("MainWindow", "Seconds"))
        self.ComboBox_Stopwatch.setItemText(1, _translate("MainWindow", "Minutes"))
        self.ComboBox_Stopwatch.setItemText(2, _translate("MainWindow", "Hours"))
        self.ComboBox_Stopwatch.setItemText(3, _translate("MainWindow", "Days"))
